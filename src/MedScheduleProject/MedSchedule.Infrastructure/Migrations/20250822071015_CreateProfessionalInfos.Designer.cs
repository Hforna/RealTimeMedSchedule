...
namespace MedSchedule.Infrastructure.Migrations
{
    ...
    [Migration("20250822071015_CreateProfessionalInfos")]
    partial class CreateProfessionalInfos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedSchedule.Domain.AggregatesModel.AppointmentAggregate.Appointment", b =>
                {
                    ...
                    b.Property<Guid?>("ProfessionalInfosId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProfessionalInfosId");
            ...
            modelBuilder.Entity("MedSchedule.Domain.AggregatesModel.UserAggregate.ProfessionalInfos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MedSchedule.Domain.AggregatesModel.AppointmentAggregate.Appointment", b =>
                {
                    b.HasOne("MedSchedule.Domain.AggregatesModel.UserAggregate.ProfessionalInfos", null)
                        .WithMany("Appointments")
                        .HasForeignKey("ProfessionalInfosId");
            ...
            modelBuilder.Entity("MedSchedule.Domain.AggregatesModel.UserAggregate.ProfessionalInfos", b =>
                {
                    ...
                    b.HasOne("MedSchedule.Domain.AggregatesModel.UserAggregate.Staff", "Staff")
                        .WithOne("ProfessionalInfos")
                        .HasForeignKey("MedSchedule.Domain.AggregatesModel.UserAggregate.ProfessionalInfos", "StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
